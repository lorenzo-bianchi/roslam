...
//////////////////////////////////////////////////
DiffDrive::DiffDrive() : dataPtr(std::make_unique<DiffDrivePrivate>()) {}
    ...
    EventManager &/*_eventMgr*/)
{
  ...
  std::string tfTopic{"/model/" + this->dataPtr->model.Name(_ecm) + "/tf"};
  ...
  ignmsg << "DiffDrive subscribing to twist messages on [" << topic << "]" << std::endl;
}

//////////////////////////////////////////////////
void DiffDrive::PreUpdate(const UpdateInfo &_info, EntityComponentManager &_ecm)
{
...
IGNITION_ADD_PLUGIN_ALIAS(DiffDrive, "custom::DiffDrive")
