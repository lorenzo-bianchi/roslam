...
exportgraphics(gcf, './figures/gt_article_not_equal.pdf', 'ContentType', 'vector');
...
exportgraphics(gcf, './figures/gt_article_not_equal.pdf', 'ContentType', 'vector');
savefig(gcf, './figures/gt_article_not_equal.fig');
...
exportgraphics(gcf, './figures/gt_article_tiled_not_equal.pdf', 'ContentType', 'vector');
savefig(gcf, './figures/gt_article_tiled_not_equal.fig');