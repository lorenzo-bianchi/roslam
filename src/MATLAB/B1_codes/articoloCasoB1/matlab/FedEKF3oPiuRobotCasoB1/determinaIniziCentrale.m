% Centrale nel senso che il terzo robot viene messo al centro in alto
% (mentre i primi due sono a sinistra e a destra in basso)
...
if (mod(nX,2)==1) % nX dispari
    coordMedia = coordX((nX+1)/2);
else
    coordMedia = coordX(nX/2);
end
