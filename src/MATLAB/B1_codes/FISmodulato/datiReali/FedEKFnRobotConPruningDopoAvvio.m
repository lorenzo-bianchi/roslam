...
KRvera = 0.005;   % Costante KR errori Odometrici ruota destra: uR_e = N(uR, KR |uR|)
...
sigmaDistanza = 30; % std in cm della misura di range
...
if robotScelto == 1
    ...
    robots(1).uRe = 100*odoRuote(IE+29:1654+28,2);
    robots(1).uLe = 100*odoRuote(IE+29:1654+28,3);
end
if robotScelto == 2
    robots(1).xVett(1) =  0.0605*100;
    robots(1).yVett(1) = 1.6437*100;
    robots(1).thetaVett(1) = -pi/2;
    robots(1).uRe = 100*odoRuote(IE+21:1654+20,2);
    robots(1).uLe = 100*odoRuote(IE+21:1654+20,3);
end
if robotScelto == 3
