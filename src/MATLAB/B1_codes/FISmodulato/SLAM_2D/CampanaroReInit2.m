% Differisce da CampanaroReInit.m essenzialmente per la matrice di
% covarianza assegnata al landmark dopo la reinizializzazione. Qui, piu'
% correttamente, si tiene contro della correlazione tra la posizione del
% robot e le prime due coordinate (xi e yi) che definiscono la posizione del landmark. 
